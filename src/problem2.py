...
class Triangle(object):
    ...
    def __init__(self, a, b, c):
        ...
        self.b = b.clone()
        self.c = c.clone()
        self.length_ab = self.a.distance_from(self.b)
        self.length_bc = self.b.distance_from(self.c)
        self.length_ca = self.c.distance_from(self.a)
        self.perimeter = self.length_ab + self.length_bc + self.length_ca
        self.area_history = []
    ...
    def area(self):
        ...
        return math.sqrt(((1 / 2) * self.perimeter) * (((1 / 2) * self.perimeter) - self.length_ab)
                         * (((1 / 2) * self.perimeter) - self.length_bc)
                         * (((1 / 2) * self.perimeter) - self.length_ca))
    ...
    def return_doubled_triangle(self):
        ...
        note = Triangle(Point(self.a.x, self.a.y), Point(self.b.x, self.b.y), Point(self.c.x, self.c.y))
        note.shrink_or_expand(2)
...
def run_test_return_doubled_triangle():
    ...
    expected_a = Point(26, 92)
    expected_b = Point(40, 102)
    expected_c = Point(160, 20)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
